        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="hidden w-full text-2xl font-semibold text-gray-800 dark:block dark:text-white">
                  Standing Out
                </div>
                </Link>
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                Who We Are At Standing Out, we believe that great software is more than just code — it’s a tool that empowers businesses to grow, evolve, and make a lasting impact. We are a passionate team of software developers, engineers, and innovators who work tirelessly to create solutions that help you stand out in the competitive digital landscape.
                </p>
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              Developed by {" "}
              <a href="https://skysailtechforge.com" rel="nofollow noopener">
                Skysail Techforge
              </a>
            </p>
          </div>
